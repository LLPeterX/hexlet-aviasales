...
----------------------------------------------
TODO:
сделал группировку по перевозчику (carrier) - типа {"S7" : [] (массив Ticket'ов этого перевозчика)}
Но это объект.
Надо сделать вывод по 5 билетов каждого перевозчика
Не понятно как сделать фильтр и сортировку по объекту.
Может, сделать 2-мерный массив типа [ ['S7', [...tickets]], ['EK', [tickets...]] ] ?
